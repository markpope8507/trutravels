...
BODY = [
    "<strong>TruTravels&rsquo; small group adventure tours for 18 to 40-somethings</strong> are built "
    "around connection, adventure and experiences that change the way you see the world.",
    # the five experience types are bold — they are product names, not description
    "See places through a <strong>Local Lens</strong>, <strong>Rise Up</strong> beyond your comfort "
    "zone, tick off <strong>Bucket List</strong> moments, discover something <strong>Tru-ly "
    "Unique</strong> and <strong>Unplug</strong> from the everyday. All led by a Local Legend, a "
    "local expert who feels more like a mate than a tour guide.",
    "<strong>Come solo. Find your people. Leave with a whole new perspective.</strong>",
]
