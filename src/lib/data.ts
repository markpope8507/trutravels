 ...
 * Each style used to carry its own hue — Classic blue, Backpacker green,
 * Multi Country amber — and every page that touched a style drew itself in
 * that colour, so /travel-styles/classic was a blue version of a pink site.
 * Pink is the accent everywhere; removing the field is what stops it coming
 * back. (Experience types DO keep their colours — that's a different system,
 * see `experienceTypes` below.)
 */
export const travelStyleConfig: Record<TravelStyle, { label: string; icon: string; logo: string; description: string }> = {
  classic: {
    label: "Classic",
...
// ============================================================
// THE TRU PROMISE — "Book With Confidence" (whats-included + homepage bar)
// ============================================================
export type TruPromise = {
  eyebrow: string;
  title: string;
  body: string;
  /** SVG path `d` for the icon (rendered stroked). */
  icon: string;
};

export const truPromises: TruPromise[] = [
  {
    eyebrow: "Low Deposit",
...
export const trips: Trip[] = [
  {
    ...
    inclusions: {
      ...
      leader: "More a mate who happens to know the way than a guide",
      activities: [
        {
...
export const stories: Story[] = [
  {
    ...
    lifeMoments: ["Gap Year", "Looking To Challenge Myself"],
  ...
  },
  {
    ...
    lifeMoments: ["Just Left Uni", "Solo Soul Searcher"],
  ...
  },
  {
    ...
    lifeMoments: ["Gap Year", "Just Left Uni"],
  ...
  },
  {
    ...
    lifeMoments: ["Gap Year", "Just Left Uni", "Work Break Recharge"],
  ...
  },
  {
    ...
    type: "guide",
    topics: ["Adventure", "Food & Culture", "Local Stories"],
    lifeMoments: ["Looking To Challenge Myself", "Gap Year"],
  ...
  },
  {
    ...
    lifeMoments: ["Work Break Recharge", "Turning 30"],
    destinations: ["Asia", "Thailand"],
    readTime: 7,
  },
  {
    ...
    lifeMoments: ["Gap Year", "Solo Soul Searcher"],
    destinations: ["Asia", "Indonesia", "Bali"],
    readTime: 9,
  },
  {
    ...
    lifeMoments: ["Solo Soul Searcher", "Just Left Uni"],
    destinations: ["Asia"],
    readTime: 6,
  },
  {
  ...
  },
  {
    ...
    lifeMoments: ["Work Break Recharge", "Solo Soul Searcher"],
  ...
  },
  {
    ...
    type: "exclusive",
    topics: ["Budget Tips"],
    lifeMoments: ["Just Left Uni", "Gap Year"],
    destinations: ["Asia"],
    readTime: 5,
  },
  {
    ...
    lifeMoments: ["Solo Soul Searcher", "Gap Year"],
    destinations: ["Asia", "Thailand"],
    readTime: 8,
  },
  {
    ...
    lifeMoments: ["Solo Soul Searcher", "Work Break Recharge", "Turning 30"],
    destinations: ["Asia", "Indonesia", "Bali"],
    readTime: 10,
  },
  {
    id: "top-things-to-do-in-peru",
    title: "Top Things to Do in Peru",
    excerpt:
      "Machu Picchu at sunrise, the Rainbow Mountains, and ceviche in Lima. How to make the most of Peru — from the Sacred Valley to the edge of the Amazon.",
    ...
    topics: ["Adventure", "Food & Culture", "Local Stories"],
    lifeMoments: ["Looking To Challenge Myself", "Gap Year"],
    destinations: ["Central & South America", "Peru"],
    readTime: 6,
  },
  {
    id: "mexico-for-first-timers",
    title: "Mexico for First-Timers",
    excerpt:
      "Tacos al pastor, cenote swims and Mayan ruins. Everything a first-timer needs to know to fall in love with Mexico.",
    image: "https://images.unsplash.com/photo-1518105779142-d975f22f1b0a?w=800&q=80",
    author: "Priya Kapoor",
    date: "2026-05-12",
    category: "Destination Guides",
    type: "guide",
    topics: ["Adventure", "Food & Culture", "Nightlife"],
    lifeMoments: ["Just Left Uni", "Solo Soul Searcher"],
    destinations: ["Central & South America", "Mexico"],
    readTime: 5,
  },
  {
    id: "costa-rica-pura-vida",
    title: "Costa Rica: A Pura Vida Adventure",
    excerpt:
      "Cloud forests, volcano hikes and surf towns where the only plan is no plan. Why Costa Rica is the ultimate reset.",
    image: "https://cdn.trutravels.com/images/costarica.jpg",
    author: "Nina Waves",
    date: "2026-04-30",
    category: "Travel Stories",
    type: "story",
    topics: ["Adventure", "Sustainability", "Wellness"],
    lifeMoments: ["Looking To Challenge Myself", "Turning 30"],
    destinations: ["Central & South America", "Costa Rica"],
    readTime: 7,
  },
  {
    id: "greek-island-hopping-guide",
    title: "The Ultimate Greek Island-Hopping Guide",
    excerpt:
      "Whitewashed villages, midnight ferries and beaches you'll never want to leave. How to island-hop the Cyclades like a pro.",
  ...
  {
    id: "albania-europes-secret",
    title: "Why Albania Is Europe's Best-Kept Secret",
    excerpt:
      "Turquoise coastlines, mountain villages and prices that feel like a glitch. Albania is the Europe trip your mates haven't done yet.",
    image: "https://cdn.trutravels.com/albania/kayaking-1.jpeg",
    author: "Tom Ashworth",
    date: "2026-04-22",
    category: "Destination Guides",
    type: "guide",
    topics: ["Adventure", "Budget Tips", "Local Stories"],
    lifeMoments: ["Gap Year", "Looking To Challenge Myself"],
    destinations: ["Europe", "Albania"],
    readTime: 5,
  },
  {
    id: "italy-backpacker-budget",
    title: "Italy on a Backpacker Budget",
    excerpt:
      "Yes, you can do Italy without going broke. Cheap eats, free sights and the trains that make it all work.",
    image: "https://images.unsplash.com/photo-1531572753322-ad063cecc140?w=800&q=80",
    author: "Tom Ashworth",
    date: "2026-03-30",
    category: "Travel Tips",
    type: "tips",
    topics: ["Budget Tips", "Food & Culture"],
    lifeMoments: ["Just Left Uni", "Gap Year"],
...
export const regions = [
  ...
  { name: "Central & South America", count: 5 },
  { name: "Europe", count: 1 },
];
...
export type Country = {
  ...
  /* NO contentSeries / podcasts. The country pages carried a "Watch & Learn"
     series rail and a "Listen" podcast list; neither is phase 1, so both are
     gone from the page and the fields with them — a dead field is how the
     section comes back. `storyContentSeries` and `storyPodcasts`, which the
     Stories and Life Moments pages use, are untouched. */
  accommodation?: {
    type: "image" | "video";
    src: string;
    poster?: string;
