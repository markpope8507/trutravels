...
const SERIES_IDS = ["scs-bangkok-48", "scs-island-hopper", "scs-bali-beyond"];
const PODCAST_IDS = ["sp-02", "sp-06"];
        ...
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                Night Out <span className="text-tru-pink">Guides</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Where to go, where to skip, what to eat at 3am.
              </p>
            </div>
        ...
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                For The <span className="text-tru-pink">Layovers</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                What it actually costs, where to stay, and how to make the year stretch.
              </p>
            </div>
