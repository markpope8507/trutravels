    ...
    <>
      ...
      <section className="relative h-[75vh] min-h-[540px] flex items-center overflow-hidden">
        <img
          ...
          alt="Backpacker map, camera and passport — the open road"
        ...
        <div className="relative z-10 w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-end">
          <div className="max-w-xl text-right">
            ...
            <p className="text-gray-200 text-base sm:text-lg italic leading-relaxed font-light max-w-md ml-auto">
              &ldquo;The University of Life. No tuition. All transformation.&rdquo;
            </p>
          </div>
        </div>
      </section>
      <Breadcrumbs crumbs={lifeMomentCrumbs("Gap Year")} />

      {/* ========================================================
          TRIPS — long itineraries + multi-country
          ======================================================== */}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-2xl">
            ...
            <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
              Trips That <span className="text-tru-pink">Build You</span>
            </h2>
            <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
              You&apos;ve got the time. Don&apos;t waste it on a long weekend. Multi-country routes, slow days, big moments — the kind of trip that becomes the story you tell forever.
            </p>
          </div>
          <TripCarouselSection
            id="gap-year-trips"
            label="Recommended"
            title="Long Roads · Real Stamps"
            labelColor="#FF3F99"
            trips={pageTrips}
          />
        </div>
      ...
      <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5 bg-gradient-to-b from-transparent via-tru-pink/[0.03] to-transparent">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
          <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
            Diaries · A Year On The Road
          </p>
          <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
            What A Year <span className="text-tru-pink">Actually Looks Like</span>
          </h2>
          <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed max-w-2xl">
            Train rides, homestays, friends made and re-found years later. Tap to play.
          </p>
        </div>
      ...
      {/* ========================================================
          READ — Articles on transformational travel / gap year
          ======================================================== */}
        ...
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                The Stuff You <span className="text-tru-pink">Learn Out There</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Hostels, packing, what to do when the plan falls apart — the unofficial syllabus.
              </p>
            </div>
      ...
      <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherLifeMoments("gap-year").map((moment) => (
              <Link
                key={moment.name}
                href={moment.href}
      ...
      <section className="pt-12 pb-24 border-t border-white/5">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95] mb-6">
            The University Of <span className="text-tru-pink">Life</span>
          </h2>
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-8">
            No application form. No tuition. Just a year, a backpack, and the bit of yourself you only meet when you&apos;re far from home.
          </p>
          <Link
            href="/explore"
