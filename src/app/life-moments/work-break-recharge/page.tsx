...
export const metadata = {
  title: "Work Break Recharge — TruTravels",
  description:
...
const VIDEO_IDS = ["v1", "v3", "v5", "v9", "v7"];
const SERIES_IDS = ["scs-bali-beyond", "scs-thai-cooking", "scs-khao-sok"];
const PODCAST_IDS = ["sp-01", "sp-05"];
const STORY_IDS = ["why-i-quit-my-job-to-travel", "member-secret-itinerary-vietnam"];
...
export default function WorkBreakRechargePage() {
    ...
    <>
      ...
      <section className="relative h-[75vh] min-h-[540px] flex items-center overflow-hidden">
        <img
          ...
          alt="Empty beach at golden hour — the office is far away"
        ...
        <div className="relative z-10 w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-end">
          <div className="max-w-xl text-right">
            ...
            <p className="text-gray-200 text-base sm:text-lg italic leading-relaxed font-light max-w-md ml-auto">
              &ldquo;Out of office. On the road. Back better.&rdquo;
            </p>
          </div>
        </div>
      </section>
      <Breadcrumbs crumbs={lifeMomentCrumbs("Work Break Recharge")} />

      {/* ========================================================
          TRIPS — short, sharp escapes
          ======================================================== */}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-2xl">
            <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
              Two Weeks · Maximum Impact
            </p>
            <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
              Escape The <span className="text-tru-pink">9 to 5</span>
            </h2>
            <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
              Trips designed for the annual leave window. Everything sorted, nothing wasted — adventure, food, beaches, real people. Land Monday, feel like a different human.
            </p>
          </div>
          <TripCarouselSection
            id="work-break-trips"
            label="Recommended"
            title="Under Two Weeks · Big Reset"
            labelColor="#FF3F99"
            trips={pageTrips}
          />
        </div>
      ...
      <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5 bg-gradient-to-b from-transparent via-tru-pink/[0.03] to-transparent">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
          <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
            Diaries · Out Of Office
          </p>
          <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
            What Two Weeks <span className="text-tru-pink">Looks Like</span>
          </h2>
          <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed max-w-2xl">
            Beaches, slow mornings, jungle treks, food you can&apos;t Google. Tap to play.
          </p>
        </div>
      ...
      {/* ========================================================
          READ — Articles for the office escapee
          ======================================================== */}
        ...
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                Reasons To <span className="text-tru-pink">Hand In Leave</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Honest stories from people who took the time off and came back changed.
              </p>
            </div>
      ...
      {pageSeries.length > 0 && (
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
                Watch · Lunch Break Bingeing
              </p>
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                Get In The <span className="text-tru-pink">Mood</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Short episodes for slow afternoons. The kind that make you start a group chat with the words &ldquo;right who&apos;s in&rdquo;.
              </p>
            </div>
      ...
      {pagePodcasts.length > 0 && (
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
                Listen · The Commute Cure
              </p>
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                For The <span className="text-tru-pink">Tube Ride</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Long-form chats for the bit of the day that&apos;s yours.
              </p>
            </div>
      ...
      <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherLifeMoments("work-break-recharge").map((moment) => (
              <Link
                key={moment.name}
                href={moment.href}
      ...
      <section className="pt-12 pb-24 border-t border-white/5">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
            Annual Leave, Maximised
          </p>
          <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95] mb-6">
            Hand In The Holiday. <span className="text-tru-pink">Book The Plane.</span>
          </h2>
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-8">
            Two weeks. No emails. Out of office on, brain off. Come back the version of yourself you keep promising you&apos;ll be.
          </p>
          <Link
            href="/explore"
