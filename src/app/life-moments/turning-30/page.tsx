...
const SERIES_IDS = ["scs-khao-sok", "scs-vietnam-n2s", "scs-island-hopper"];
const PODCAST_IDS = ["sp-01", "sp-05", "sp-03"];
      ...
      {pageSeries.length > 0 && (
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none select-none absolute -left-16 sm:-left-24 lg:-left-28 -top-8 w-[260px] sm:w-[420px] lg:w-[600px] opacity-[0.06] brightness-0 invert"
          />
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              <p className="text-tru-pink text-[11px] font-bold uppercase tracking-[0.3em] font-heading mb-3">
                Watch · Adventure Series
              </p>
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                Wilder <span className="text-tru-pink">Watching</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Jungles, valleys, dragons, and slow boats. The bingeable stuff that&apos;ll have you Googling visas at midnight.
              </p>
            </div>
        ...
        <section className="relative pt-12 pb-16 overflow-hidden border-t border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[0.95]">
                For The <span className="text-tru-pink">Quiet Bits</span>
              </h2>
              <p className="text-gray-300 mt-5 text-base sm:text-lg leading-relaxed">
                Travel as a force for change. Local voices. Honest takes on what travel does to you in your late twenties.
              </p>
            </div>
