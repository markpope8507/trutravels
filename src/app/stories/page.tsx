  ...
  return (
    <>
      ...
      <section className="pt-16 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-12 flex items-center justify-between gap-8">
          ...
          <div className="text-tru-pink hidden md:block flex-shrink-0">
            <WatchIcon />
          </div>
        </div>
