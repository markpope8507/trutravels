  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute top-3 left-3 h-11 w-11 rounded-full bg-white/90 text-tru-navy flex items-center justify-center group-hover:bg-tru-pink group-hover:text-white group-hover:scale-110 transition-all shadow-lg shadow-black/20">
