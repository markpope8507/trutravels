              ...
              <Link href={tripUrl(trip)} className="group block">
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    {trip.memberOnly && (
                      <div className="absolute top-3 right-3 bg-tru-pink text-white text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full font-heading" style={{ filter: "drop-shadow(2px 2px 3px rgba(0,0,0,0.5))" }}>Members Only</div>
                    )}
                  </div>
                  <div className="p-4">
                    ...
                    <p className="text-tru-pink text-[10px] font-bold uppercase tracking-wider mb-2 font-heading">{trip.region} &middot; {trip.destination}</p>
                    {trip.rating && (
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-white/10">
                      {trip.originalPrice && (
                        <span className="text-gray-500 text-base line-through">&pound;{trip.originalPrice}</span>
                      )}
