  ...
  return (
    <Link href={tripUrl(trip)} className="group block">
      <div className="rounded-[10px] bg-white/5 border border-white/5 hover:border-tru-pink/20 transition-all duration-300 overflow-hidden" style={{ boxShadow: "0px 5px 25px -5px rgba(0,0,0,0.3)" }}>
        ...
        <div className="p-4">
          <h3 className="text-sm font-bold text-white font-heading leading-tight group-hover:text-tru-pink transition-colors mb-2">{trip.title} &mdash; {trip.duration}</h3>
          <p className="text-gray-400 text-xs mb-2 line-clamp-2">{trip.tagline}</p>
          {trip.rating && (
